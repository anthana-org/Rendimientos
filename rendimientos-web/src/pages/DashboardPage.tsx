  ...
  return (
    <div className="space-y-8 sm:space-y-12 lg:space-y-16 bg-dark-bg min-h-screen">
      <div className="max-w-7xl xl:max-w-screen-2xl 2xl:max-w-[90vw] mx-auto pl-8 sm:pl-12 lg:pl-16 xl:pl-20 2xl:pl-24 pr-2 sm:pr-3 lg:pr-4 xl:pr-6 2xl:pr-8 pt-8 sm:pt-12 lg:pt-16">
        ...
        <div className="bg-dark-bgSecondary rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-12 xl:p-16 border-2 border-dark-border hover:border-green-400 hover:shadow-green-500/20 hover:shadow-3xl hover:-translate-y-1 transition-all duration-500 ease-out mt-8 sm:mt-12 lg:mt-16 mb-8 sm:mb-12 lg:mb-16">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 sm:mb-10 lg:mb-12 gap-6 sm:gap-8">
            <div>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-dark-textSecondary">Evolución de tu patrimonio en el tiempo</p>
            </div>
            <div className="flex space-x-3 sm:space-x-4 lg:space-x-6">
              ...
              <button className="px-8 py-4 sm:px-10 sm:py-5 lg:px-12 lg:py-6 bg-dark-bgTertiary text-dark-textSecondary rounded-xl border border-dark-border text-base sm:text-lg lg:text-xl font-medium hover:bg-dark-bgSecondary hover:text-white hover:border-green-500/50 hover:scale-105 transition-all duration-300 ease-out">
                1A
              </button>
              <button className="px-8 py-4 sm:px-10 sm:py-5 lg:px-12 lg:py-6 bg-dark-bgTertiary text-dark-textSecondary rounded-xl border border-dark-border text-base sm:text-lg lg:text-xl font-medium hover:bg-dark-bgSecondary hover:text-white hover:border-green-500/50 hover:scale-105 transition-all duration-300 ease-out">
                Todo
          ...
          <div className="h-80 sm:h-96 lg:h-[32rem] xl:h-[40rem] flex items-center justify-center bg-gradient-to-br from-dark-bgTertiary to-dark-bg rounded-2xl sm:rounded-3xl border-2 border-dark-border hover:border-green-400/50 transition-all duration-500">
            <div className="text-center px-8">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-dark-textSecondary mb-2">Visualización interactiva de tu crecimiento</p>
        ...
        <div className="bg-gradient-to-br from-dark-bgSecondary via-dark-bgTertiary to-dark-bgSecondary rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-12 xl:p-16 border-4 border-dark-border hover:border-green-400 hover:shadow-green-500/20 hover:shadow-3xl hover:-translate-y-1 transition-all duration-500 ease-out ring-2 ring-dark-borderLight hover:ring-green-400/30 mt-8 sm:mt-12 lg:mt-16 mb-8 sm:mb-12 lg:mb-16">
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-semibold text-dark-textSecondary mb-2 sm:mb-3">Balance Total</h2>
            ...
            <div className="flex items-center justify-center space-x-4 sm:space-x-8">
              ...
              <span className="text-lg sm:text-xl lg:text-2xl xl:text-3xl text-dark-textSecondary">este mes</span>
            </div>
          </div>
          
          {/* Métricas principales en fila */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <div className="text-center p-4 sm:p-6 lg:p-8 bg-dark-bgSecondary/50 rounded-xl sm:rounded-2xl border border-dark-border">
              <div className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-2">$235,000</div>
              <div className="text-sm sm:text-base lg:text-lg text-dark-textSecondary mb-1">Rendimiento Total</div>
            ...
            <div className="text-center p-4 sm:p-6 lg:p-8 bg-dark-bgSecondary/50 rounded-xl sm:rounded-2xl border border-dark-border">
              ...
              <div className="text-sm sm:text-base lg:text-lg text-dark-textSecondary mb-1">Balance Actual</div>
              <div className="text-green-400 font-semibold text-base sm:text-lg lg:text-xl">+9.2%</div>
            </div>
            
            <div className="text-center p-4 sm:p-6 lg:p-8 bg-dark-bgSecondary/50 rounded-xl sm:rounded-2xl border border-dark-border sm:col-span-2 lg:col-span-1">
              <div className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-2">12</div>
              <div className="text-sm sm:text-base lg:text-lg text-dark-textSecondary mb-1">Inversiones Activas</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 mt-8 sm:mt-12 lg:mt-16 mb-8 sm:mb-12 lg:mb-16">
          ...
          <div className="bg-dark-bgSecondary rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-10 border-2 border-dark-border hover:border-green-400 hover:shadow-green-500/20 hover:-translate-y-1 transition-all duration-500 ease-out">
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 lg:p-6 bg-green-500/10 border border-green-500/30 rounded-lg sm:rounded-xl hover:bg-green-500/15 hover:border-green-400/50 hover:scale-[1.02] transition-all duration-300 ease-out">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-dark-textSecondary text-xs sm:text-sm">Diciembre 2024</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 sm:p-6 bg-blue-500/10 border border-blue-500/30 rounded-xl sm:rounded-2xl">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-dark-textSecondary text-xs sm:text-sm">Últimos 12 meses</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 sm:p-6 bg-purple-500/10 border border-purple-500/30 rounded-xl sm:rounded-2xl">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-dark-textSecondary text-xs sm:text-sm">Desde el inicio</p>
                  </div>
                </div>
          ...
          <div className="bg-dark-bgSecondary rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 lg:p-8 border-2 border-dark-border hover:border-green-500/30 transition-all duration-300">
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-6 sm:mb-8">Métricas Adicionales</h3>
            <div className="space-y-4 sm:space-y-6">
              <div className="p-4 sm:p-6 bg-dark-bgTertiary/50 rounded-xl sm:rounded-2xl border border-dark-border">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <span className="text-dark-textSecondary font-medium text-sm sm:text-base">Total Contratos</span>
              ...
              <div className="p-4 sm:p-6 bg-dark-bgTertiary/50 rounded-xl sm:rounded-2xl border border-dark-border">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <span className="text-dark-textSecondary font-medium text-sm sm:text-base">Rendimiento %</span>
              ...
              <div className="p-4 sm:p-6 bg-dark-bgTertiary/50 rounded-xl sm:rounded-2xl border border-dark-border">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <span className="text-dark-textSecondary font-medium text-sm sm:text-base">ROI Promedio</span>
        ...
        {/* Tabla Detallada */}
        <div className="bg-dark-bgSecondary rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-dark-border hover:border-green-500/30 transition-all duration-300 overflow-hidden">
          <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-dark-border">
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">Rendimientos Detallados</h3>
            <p className="text-dark-textSecondary mt-1 sm:mt-2 text-sm sm:text-base">Historial completo de tus inversiones</p>
          </div>
